...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        Animations animations = KevinClient.moduleManager.getModule(Animations.class);
    ...
    // easy use for kt
    public double jumpUpwardsMotionDouble() {
...
//        this.motionY = getJumpUpwardsMotion(); // 0.42F
    ...
    public void onLivingUpdate()
    {
        ...
        if (Objects.requireNonNull(KevinClient.moduleManager.getModule(AirJump.class)).getState() && isJumping && this.jumpTicks == 0) {
            this.jump();
            this.jumpTicks = 10;
        }
    ...
    {
        List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().expand(0.2F, 0.0D, 0.2F), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate<Entity>()
        {
